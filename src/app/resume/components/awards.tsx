        ...
        <div>
            <div className="space-y-8 pt-4">
                <div className="space-y-1">
                    ...
                    <p>
                        Received $500 from the Office of Undergraduate Research based on project <span className="italic">WUMT: Wavelet U-Net Motion Transformer</span>.
                    </p>
                </div>
                <div className="space-y-1">
                    <div className="flex justify-between items-center space-x-2">
                ...
                <div className="space-y-1">
                    ...
                    <p>
                        Recieved conference award for presentation done on open set recognition in ResNet models.
                    </p>
                </div>
                <div className="space-y-1">
                    <div className="flex justify-between items-center space-x-2">
                    ...
                    <p>
                        Recieved research award for improvement of open set recognition accuracy in ResNet models at Sungkyunkwan University.
                    </p>
                </div>
                <div className="space-y-1">
                    <div className="flex justify-between items-center space-x-2">
                    ...
                    <p>
                        Recieved AZ-900 certification from Microsoft on artificial intelligence & Microsoft Azure fundamentals.
                    </p>
                </div>
                <div className="space-y-1">
                    <div className="flex justify-between items-center space-x-2">
                    ...
                    <p>
                        Recieved research award for work on advertisement classification with OCR and semantic tree matching.
                    </p>
                </div>
            </div>
        </div>
